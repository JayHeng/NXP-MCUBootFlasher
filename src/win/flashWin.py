...
class flashWin ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		wSizer_status = wx.WrapSizer( wx.HORIZONTAL, wx.WRAPSIZER_DEFAULT_FLAGS )

		self.m_gauge_action = wx.Gauge( self, wx.ID_ANY, 100, wx.DefaultPosition, wx.Size( 380,20 ), wx.GA_HORIZONTAL )
		self.m_gauge_action.SetValue( 100 )
		wSizer_status.Add( self.m_gauge_action, 0, wx.ALL, 5 )

		self.m_bitmap_nxp = wx.StaticBitmap( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size( 80,30 ), 0 )
		wSizer_status.Add( self.m_bitmap_nxp, 0, wx.ALL, 5 )


		wSizer_func.Add( wSizer_status, 1, wx.EXPAND, 5 )
