...
### 1 软件概览
#### 1.1 介绍
　　RT-Flash是一个专为基于NXP i.MX RT系列芯片的产品量产而设计的工具，其功能与官方MfgTool2工具类似，但是解决了MfgTool2工具在实际使用中的一些痛点：  

> * 使用MfgTool2仅能在xml中指定.sb文件，无法直接在GUI里选择.sb文件；  
> * 使用MfgTool2仅能选择USB端口，无法使用UART端口；  
> * 使用MfgTool2的USB端口下载时，有时无法识别某些Hub连接;  
...
　　确认HID设备存在之后，在【Port Setup】选中USB-HID即可。  

![RT-Flash_setPort_e](http://henjay724.com/image/cnblogs/rtFlash_v1_0_0_setPort_e.png)

#### 3.3 点击一键下载
　　选中要下载的.sb文件，直接点击【All-In-One Action】按钮便可将.sb文件下载进启动设备。如果成功下载，【All-In-One Action】按钮背景会变蓝色，并且状态栏里会显示"Application image file (.sb) has been downloaded successfully!"。  
